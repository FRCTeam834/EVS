...
class PostProc(multiprocessing.Process):
    def __init__(self, results_queue, *args, **kwargs):
        super(PostProc, self).__init__(*args, **kwargs)
        self._results_queue = results_queue

    def _perform_post_proc(self):
        # Setup NetworkTables
...
def main():
    ...
    # Results queue for sending results to post processing
    results_queue = multiprocessing.Queue()
    post_proc = PostProc(results_queue)
    post_proc.start()
